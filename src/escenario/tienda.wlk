...
object guerrero {
	...
	method tomarUna() = new Guerrero(position = game.at(1,1), image = "transparente.png", jugadorDuenio = tienda.jugadorActual(), tipo = "guerrero", comandante = tienda.jugadorActual().getUnidades().head(), rangoDeAccion = 4, rangoEspecial = 1,nivelAtaque = 24, nivelDefensa = 20)
}
object tirador {
	method reservarUnidad() {
	...
	method tomarUna() = new Tirador(position = game.at(2,2), image = "transparente.png", jugadorDuenio = tienda.jugadorActual(), tipo = "tirador", comandante = tienda.jugadorActual().getUnidades().head(), rangoDeAccion = 5, rangoEspecial = 2,nivelAtaque = 24, nivelDefensa = 20)
}
object caballeria {
	method reservarUnidad() {
		tienda.getGuerreroJug().image("guerrero"+ tienda.jugadorActual().getId() + "gris.png")
	...
	method tomarUna() = new Caballeria(position = game.at(3,3), image = "transparente.png", jugadorDuenio = tienda.jugadorActual(), tipo = "caballeria", comandante = tienda.jugadorActual().getUnidades().head(), rangoDeAccion = 6, rangoEspecial = 1,nivelAtaque = 24, nivelDefensa = 20) 
}
